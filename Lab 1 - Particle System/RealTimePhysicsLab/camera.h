...
class Camera
{
	public:
		...
		glm::mat4 GenerateViewMatrix();		//Generates a view matrix using current parameters.
		glm::mat4 GenerateProjMatrix();	//Generates a projection matrix for the given resolution.
