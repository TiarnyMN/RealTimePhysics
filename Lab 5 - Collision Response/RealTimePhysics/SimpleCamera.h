...
class SimpleCamera
{
	public:
		...
		void SetNewTarget(glm::vec3 newTarget);
		...
		GLfloat distance, verticalOffset, camSpin;
	...
	private:
		...
		GLfloat camFOV, camNear, camFar;	//Variables used for the matrices. CamSpin controls the rate at which the camera spins around the object.
